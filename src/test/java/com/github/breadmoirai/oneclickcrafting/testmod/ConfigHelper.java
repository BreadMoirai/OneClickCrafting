...
public class ConfigHelper {
    ...
    /**
     * Opens ModsScreen, clicks the one-click-crafting entry to select it, clicks
     * its Configure button, and waits until the YACLScreen is active.
     */
     ...
     * With a world active the HUD is restored (screen == null); without a world
     * the game falls back to TitleScreen.
     */
    ...
    /** Returns the current pending (displayed) Boolean value of the named YACL toggle. */
    public boolean getYaclToggleState(String label) {
        return context.computeOnClient(mc -> {
            YACLScreen screen     = (YACLScreen) mc.currentScreen;
    ...
    /** Simulates a left-click on the YACL tick-box for the given label. */
    ...
    /** Sets the named YACL toggle to {@code desired}; only clicks if the current state differs. */
