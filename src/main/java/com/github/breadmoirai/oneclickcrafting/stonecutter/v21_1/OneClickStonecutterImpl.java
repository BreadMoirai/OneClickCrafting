...
public class OneClickStonecutterImpl implements OneClickStonecutter {
   ...
   public void selectRecipe(int recipeId) {
      ...
      if (!(minecraft.gui.screen() instanceof StonecutterScreen screen)) return;
   ...
   public OneClickStonecutterRecipe getRecipe(int recipeId) {
      ...
      if (!(minecraft.gui.screen() instanceof StonecutterScreen screen)) return OneClickStonecutterRecipe.EMPTY;
      StonecutterMenu menu = screen.getMenu();
      ...
      RecipeHolder<StonecutterRecipe> holder = recipes.get(recipeId);
