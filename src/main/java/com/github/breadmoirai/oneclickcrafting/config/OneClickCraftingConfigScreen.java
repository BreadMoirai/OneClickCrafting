      ...
      return ConfigCategory.createBuilder()
         ...
         .group(OptionGroup.createBuilder()
            .option(Option.<Boolean>createBuilder().name(text("config.oneclickcrafting.stonecutter"))
               ...
               .binding(OneClickCraftingConfig.DEFAULT_ENABLE_STONECUTTER, config::isEnableStonecutter, config::setEnableStonecutter)
               ...
               .binding(OneClickCraftingConfig.DEFAULT_ENABLE_LEFT_CLICK, config::isEnableLeftClick, config::setEnableLeftClick)
               .controller(TickBoxControllerBuilder::create)
               .build()
               ...
               .binding(OneClickCraftingConfig.DEFAULT_ENABLE_RIGHT_CLICK, config::isEnableRightClick, config::setEnableRightClick)
               .controller(TickBoxControllerBuilder::create)
               .build()
               ...
               .binding(OneClickCraftingConfig.DEFAULT_ALWAYS_ON, config::isAlwaysOn, config::setAlwaysOn)
               .controller(TickBoxControllerBuilder::create)
               .build()
               ...
               .binding(OneClickCraftingConfig.DEFAULT_ALT_HOLD, config::isAltHold, config::setAltHold)
               .controller(TickBoxControllerBuilder::create)
               .build()
               ...
               .binding(OneClickCraftingConfig.DEFAULT_CTRL_HOLD, config::isCtrlHold, config::setCtrlHold)
               .controller(TickBoxControllerBuilder::create)
               .build()
               ...
               .binding(OneClickCraftingConfig.DEFAULT_DROP_ENABLE, config::isDropEnable, config::setDropEnable)
               .controller(TickBoxControllerBuilder::create)
               .build()
               ...
               .binding(OneClickCraftingConfig.DEFAULT_REPEAT_DELAY, config::getRepeatDelay, config::setRepeatDelay)
               ...
               .binding(OneClickCraftingConfig.DEFAULT_REPEAT_INTERVAL, config::getRepeatInterval, config::setRepeatInterval)
               .controller(opt -> IntegerSliderControllerBuilder.create(opt)
                  .range(0, 40)
                  .step(1)
               ...
               .binding(OneClickCraftingConfig.DEFAULT_DEBUG_LOGGING, config::isDebugLogging, config::setDebugLogging)
               .controller(TickBoxControllerBuilder::create)
               .build()
            ).build()
         ).build();
